...
import com.dermotherlihy.quotation.model.CommentDataOnDemand;
...
privileged aspect CommentIntegrationTest_Roo_IntegrationTest {
    ...
    public void CommentIntegrationTest.testCountComments() {
        ...
        long count = com.dermotherlihy.quotation.model.Comment.countComments();
    ...
    public void CommentIntegrationTest.testFindComment() {
        com.dermotherlihy.quotation.model.Comment obj = dod.getRandomComment();
        ...
        obj = com.dermotherlihy.quotation.model.Comment.findComment(id);
    ...
    public void CommentIntegrationTest.testFindAllComments() {
        ...
        java.util.List<com.dermotherlihy.quotation.model.Comment> result = com.dermotherlihy.quotation.model.Comment.findAllComments();
    ...
    public void CommentIntegrationTest.testFindCommentEntries() {
        ...
        java.util.List<com.dermotherlihy.quotation.model.Comment> result = com.dermotherlihy.quotation.model.Comment.findCommentEntries(0, (int) count);
    ...
    public void CommentIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyComment(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.dermotherlihy.quotation.model.Comment merged = (com.dermotherlihy.quotation.model.Comment) obj.merge();
        obj.flush();
    ...
    public void CommentIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Comment' failed to initialize correctly", dod.getRandomComment());
        com.dermotherlihy.quotation.model.Comment obj = dod.getNewTransientComment(Integer.MAX_VALUE);
    ...
    public void CommentIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Comment' with identifier '" + id + "'", com.dermotherlihy.quotation.model.Comment.findComment(id));
    }
