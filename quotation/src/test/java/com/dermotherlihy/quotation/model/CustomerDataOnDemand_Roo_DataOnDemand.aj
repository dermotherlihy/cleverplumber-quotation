...
privileged aspect CustomerDataOnDemand_Roo_DataOnDemand {
    ...
    public void CustomerDataOnDemand.setTitle(Customer obj, int index) {
    ...
    public void CustomerDataOnDemand.setAddressLine1(Customer obj, int index) {
    ...
    public void CustomerDataOnDemand.setAddressLine2(Customer obj, int index) {
    ...
    public void CustomerDataOnDemand.setAddressLine3(Customer obj, int index) {
    ...
    public void CustomerDataOnDemand.setEmailAddress(Customer obj, int index) {
