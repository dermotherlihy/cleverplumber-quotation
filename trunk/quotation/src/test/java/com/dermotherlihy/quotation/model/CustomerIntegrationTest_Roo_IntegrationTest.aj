...
import com.dermotherlihy.quotation.model.CustomerDataOnDemand;
...
privileged aspect CustomerIntegrationTest_Roo_IntegrationTest {
    ...
    public void CustomerIntegrationTest.testCountCustomers() {
        ...
        long count = com.dermotherlihy.quotation.model.Customer.countCustomers();
    ...
    public void CustomerIntegrationTest.testFindAllCustomers() {
        ...
        java.util.List<com.dermotherlihy.quotation.model.Customer> result = com.dermotherlihy.quotation.model.Customer.findAllCustomers();
    ...
    public void CustomerIntegrationTest.testFindCustomerEntries() {
        ...
        java.util.List<com.dermotherlihy.quotation.model.Customer> result = com.dermotherlihy.quotation.model.Customer.findCustomerEntries(0, (int) count);
    ...
    public void CustomerIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyCustomer(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.dermotherlihy.quotation.model.Customer merged = (com.dermotherlihy.quotation.model.Customer) obj.merge();
        obj.flush();
    ...
    public void CustomerIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Customer' failed to initialize correctly", dod.getRandomCustomer());
        com.dermotherlihy.quotation.model.Customer obj = dod.getNewTransientCustomer(Integer.MAX_VALUE);
